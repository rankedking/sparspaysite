                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-12 my-16'>
                        ...
                        <div className='col-span-7'>
                            <h1 className="text-4xl lg:text-7xl font-bold mb-5 text-white md:4px md:text-start text-center">
                                Easiest Payment Method <br /> with SparsPay
                            </h1>
                            <p className='text-white md:text-lg font-normal mb-10 md:text-start text-center'>Sparspay enables individuals and businesses to simply <br /> settle payments to international and crypto currencies <br /> in their local currency.</p>
                        ...
                        <div className='col-span-5 lg:-m-48'>
                            ...
                            <Image src="/images/Banner/bannern.png" alt="nothing" width={1013} height={760} />
